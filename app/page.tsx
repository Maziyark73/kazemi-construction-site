import { Phone, ShieldCheck, Users, Clock3, Handshake, Home, Bath, Hammer, Trees, Building2, ArrowRight, Mail, MapPin } from "lucide-react";
          ...
          <div className="relative mx-auto grid min-h-[700px] max-w-7xl items-center gap-12 px-6 py-20 lg:grid-cols-[1fr_420px]">
            ...
            <div id="estimate" className="rounded-2xl bg-white p-7 text-neutral-900 shadow-2xl">
              ...
              <form className="space-y-4">
                <input className="w-full rounded-md border border-neutral-300 px-4 py-3 outline-none focus:border-amber-500" placeholder="Full Name" />
                <input className="w-full rounded-md border border-neutral-300 px-4 py-3 outline-none focus:border-amber-500" placeholder="Phone Number" />
                <input className="w-full rounded-md border border-neutral-300 px-4 py-3 outline-none focus:border-amber-500" placeholder="Email Address" />
                <select className="w-full rounded-md border border-neutral-300 px-4 py-3 text-neutral-500 outline-none focus:border-amber-500">
                ...
                <textarea className="h-28 w-full rounded-md border border-neutral-300 px-4 py-3 outline-none focus:border-amber-500" placeholder="Tell us about your project" />
                <button type="button" className="w-full rounded-md bg-gradient-to-r from-amber-500 to-yellow-600 px-6 py-4 text-sm font-black uppercase tracking-wide text-white">Submit Request</button>
              </form>
            </div>
          </div>
        </section>
        ...
        <section id="contact" className="bg-white px-6 py-16 text-neutral-950">
          <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-2">
            ...
            <div className="rounded-2xl bg-neutral-950 p-8 text-white shadow-2xl">
              ...
              <form className="space-y-4">
                <input className="w-full rounded-md border border-white/10 bg-white/10 px-4 py-3 outline-none placeholder:text-neutral-400 focus:border-amber-500" placeholder="Your Name" />
                <input className="w-full rounded-md border border-white/10 bg-white/10 px-4 py-3 outline-none placeholder:text-neutral-400 focus:border-amber-500" placeholder="Phone Number" />
                <textarea className="h-28 w-full rounded-md border border-white/10 bg-white/10 px-4 py-3 outline-none placeholder:text-neutral-400 focus:border-amber-500" placeholder="What do you need done?" />
                <button type="button" className="w-full rounded-md bg-gradient-to-r from-amber-500 to-yellow-600 px-6 py-4 text-sm font-black uppercase tracking-wide text-white">Send Request</button>
              </form>
            </div>
          </div>
        </section>
